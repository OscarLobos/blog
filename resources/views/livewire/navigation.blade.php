                ...
                <div class="relative ml-3" x-data="{ open: false }">
                    <div>
                        ...
                        <span class="inline-flex rounded-md">
                            <button x-on:click="open = true" type="button"
                                class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out bg-gray-800 border border-transparent rounded-md hover:text-white focus:outline-none">
                                {{ Auth::user()->name }}
                    ...
                    <div x-show="open" x-on:click.away="open = false"
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a href="{{ route('logout') }}"
                                ...
                                this.closest('form').submit();">Salir
                            </a>
                        </form>
                    </div>
                </div>
